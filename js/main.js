...
/* harmony import */ var _components_gallery__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_components_gallery__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony import */ var _components_dynamic_adapt__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/dynamic-adapt */ "./src/js/components/dynamic-adapt.js");
...
/***/ "./src/js/components/dynamic-adapt.js":
/*!********************************************!*\
  !*** ./src/js/components/dynamic-adapt.js ***!
  \********************************************/
/***/ (() => {
...
const mainArr = [itemSixth, itemFirst, itemNineth, itemThird, itemSeventh, itemSecond, itemTenth, itemFourth, itemFifth];
...
(function () {
  ...
  burger === null || burger === void 0 ? void 0 : burger.addEventListener("click", e => {
    ...
    headerFilter === null || headerFilter === void 0 ? void 0 : headerFilter.classList.toggle("hide-backdrop-filter");
  ...
  menuItems === null || menuItems === void 0 ? void 0 : menuItems.forEach(el => {
    el.addEventListener("click", () => {
      ...
      menu.classList.remove("menu--active");
      navMenu.classList.remove("mob-menu--show");
      headerFilter === null || headerFilter === void 0 ? void 0 : headerFilter.classList.remove("hide-backdrop-filter");
      (0,_functions_enable_scroll__WEBPACK_IMPORTED_MODULE_1__.enableScroll)();
    });
  });
})();
